        ...
        <>
            ...
            >
                <Dialog
                    ...
                    className="z-50 inset-0 fixed flex justify-center items-center "
                >
                    <div className="fixed inset-0 bg-black/70 " aria-hidden="true" />
                    <Dialog.Panel className="z-10 bg-mikado-yellow px-6 py-4 rounded-xl">
                        <Dialog.Title
                            className={"text-2xl font-bold text-black"}>Deactivate account</Dialog.Title>
